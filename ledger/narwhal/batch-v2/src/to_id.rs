...
impl<N: Network> BatchV2<N> {
    /// Computes the batch ID from the given fields.
    pub fn compute_batch_id(
        ...
        // Insert the number of previous batch IDs.
        u32::try_from(previous_batch_ids.len())?.write_le(&mut preimage)?;
        // Insert the previous batch IDs.
