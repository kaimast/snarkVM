...
impl<N: Network> Serialize for SubdagV2<N> {
    /// Serializes the subdag to a JSON-string or buffer.
    fn serialize<S: Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match serializer.is_human_readable() {
            true => {
                let mut s = serializer.serialize_struct("SubdagV2", 1)?;
                s.serialize_field("subdag", &self.subdag)?;
                s.end()
            }
...
impl<'de, N: Network> Deserialize<'de> for SubdagV2<N> {
    ...
    fn deserialize<D: Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        if deserializer.is_human_readable() {
            ...
            FromBytesUncheckedDeserializer::<Self>::deserialize_with_size_encoding(deserializer, "subdag v2")
        }
    }
}
